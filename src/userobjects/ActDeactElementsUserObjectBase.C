...
InputParameters
ActDeactElementsUserObjectBase::validParams()
{
  InputParameters params = ElementUserObject::validParams();
  params.addClassDescription("Determine activated and inactivated elements.");
  params.addRequiredParam<subdomain_id_type>("active_subdomain_id", "The active subdomain ID = solid.");
  params.addRequiredParam<subdomain_id_type>("deactive_subdomain_id", "The deactivated subdomain ID = gas or liquid.");  
...
ActDeactElementsUserObjectBase::ActDeactElementsUserObjectBase(const InputParameters & parameters)
  : ElementUserObject(parameters),
    ...
    _deactive_subdomain_id(declareRestartableData<subdomain_id_type>(
        "deactive_subdomain_id", getParam<subdomain_id_type>("deactive_subdomain_id"))),
...
void
ActDeactElementsUserObjectBase::setNewBoundaryName()
{
...
void
ActDeactElementsUserObjectBase::execute()
{
  ...
  if (!isElementActivated() && _current_elem->subdomain_id() != _deactive_subdomain_id &&
      _current_elem->subdomain_id() != _inactive_subdomain_id)
  {
    /*
      _current_elem subdomain id is not assignable
    ...
    */
    ...
    // Add element to the activate subdomain
    ele->subdomain_id() = _deactive_subdomain_id;
    ...
    {
      Elem * disp_ele = displaced_problem->mesh().elemPtr(ele_id);
      disp_ele->subdomain_id() = _deactive_subdomain_id;
    }
  }  
}

void
ActDeactElementsUserObjectBase::finalize()
{
  /*
...
void
ActDeactElementsUserObjectBase::getNodesToRemoveFromBnd(std::set<dof_id_type> & remove_set,
...
void
ActDeactElementsUserObjectBase::insertNodeIdsOnSide(const Elem * ele,
...
void
ActDeactElementsUserObjectBase::updateBoundaryInfo(MooseMesh & mesh)
{
...
void
ActDeactElementsUserObjectBase::push_boundary_side_info(
    MooseMesh & mesh,
    std::unordered_map<processor_id_type, std::vector<std::pair<dof_id_type, unsigned int>>> &
        elems_to_push)
{
...
void
ActDeactElementsUserObjectBase::push_boundary_node_info(
    MooseMesh & mesh,
...
ConstElemRange *
ActDeactElementsUserObjectBase::getNewlyActivatedElementRange()
{
...
ConstBndNodeRange *
ActDeactElementsUserObjectBase::getNewlyActivatedBndNodeRange()
{
  // deletes the object first
...
ConstNodeRange *
ActDeactElementsUserObjectBase::getNewlyActivatedNodeRange()
{
  // deletes the object first
...
bool
ActDeactElementsUserObjectBase::isNewlyActivated(const Node * nd)
{
...
void
ActDeactElementsUserObjectBase::initSolutions(ConstElemRange & elem_range,
