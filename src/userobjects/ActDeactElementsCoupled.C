...
registerMooseObject("MooseApp", ActDeactElementsCoupled);

InputParameters
ActDeactElementsCoupled::validParams()
{
...
ActDeactElementsCoupled::ActDeactElementsCoupled(const InputParameters & parameters)
...
bool
ActDeactElementsCoupled::isElementActivated()
{
