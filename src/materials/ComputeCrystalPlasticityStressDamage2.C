...
#include "ComputeCrystalPlasticityStressDamage2.h"
...
registerMooseObject("TensorMechanicsApp", ComputeCrystalPlasticityStressDamage2);

InputParameters
ComputeCrystalPlasticityStressDamage2::validParams()
{
...
ComputeCrystalPlasticityStressDamage2::ComputeCrystalPlasticityStressDamage2(
...
void
ComputeCrystalPlasticityStressDamage2::initQpStatefulProperties()
{
...
void
ComputeCrystalPlasticityStressDamage2::initialSetup()
{
  ...
  for (unsigned int i = 0; i < _num_models; ++i)
  {
    ...
    if (model)
    {
      ...
      mooseError("Model " + model_names[i] +
                 " is not compatible with ComputeCrystalPlasticityStressDamage2");
  }
...
void
ComputeCrystalPlasticityStressDamage2::computeQpStress()
{
  for (unsigned int i = 0; i < _num_models; ++i)
    _dislocation_models[i]->setQp(_qp);
...
void
ComputeCrystalPlasticityStressDamage2::updateStress(RankTwoTensor & cauchy_stress,
...
void
ComputeCrystalPlasticityStressDamage2::preSolveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
...
void
ComputeCrystalPlasticityStressDamage2::solveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
...
void
ComputeCrystalPlasticityStressDamage2::postSolveQp(RankTwoTensor & cauchy_stress,
                                                    RankFourTensor & jacobian_mult)
{
...
void
ComputeCrystalPlasticityStressDamage2::updatePlasticWork()
{
...
void
ComputeCrystalPlasticityStressDamage2::solveStateVariables()
{
...
void
ComputeCrystalPlasticityStressDamage2::calculateResidual()
{
...
void
ComputeCrystalPlasticityStressDamage2::calculateJacobian()
{
...
void
ComputeCrystalPlasticityStressDamage2::computeStrainVolumetric(Real & F_pos, Real & F_neg, 
...
void
ComputeCrystalPlasticityStressDamage2::computeHistoryVariable(Real & F_pos, Real & F_neg)
{
...
void
ComputeCrystalPlasticityStressDamage2::elastoPlasticTangentModuli(RankFourTensor & jacobian_mult)
{
