...
#include "CrystalPlasticityDislocationAustenite.h"
#include "libmesh/int_range.h"
#include <cmath>
#include "Function.h"

registerMooseObject("c_pfor_amApp", CrystalPlasticityDislocationAustenite);

InputParameters
CrystalPlasticityDislocationAustenite::validParams()
{
  ...
  params.addClassDescription("Dislocation based model for crystal plasticity "
                             ...
                             "Specially for Austenite steel for FCC/BCC in AM process. ");
  ...
  params.addParam<Real>("y_c_T_coeff", 0.0, "Coefficient for temperature dependence of y_c");  
...
CrystalPlasticityDislocationAustenite::CrystalPlasticityDislocationAustenite(
...
void
CrystalPlasticityDislocationAustenite::initQpStatefulProperties()
{
  ...
  for (const auto i : make_range(_number_slip_systems))
  {
	...
	_slip_resistance[_qp][i] += (_alpha_0 * effective_shear_modulus * _burgers_vector_mag
...
// of the plastic slip rate
void
CrystalPlasticityDislocationAustenite::calculateSchmidTensor(
...
void
CrystalPlasticityDislocationAustenite::setInitialConstitutiveVariableValues()
{
...
void
CrystalPlasticityDislocationAustenite::setSubstepConstitutiveVariableValues()
{
...
bool
CrystalPlasticityDislocationAustenite::calculateSlipRate()
{
...
void
CrystalPlasticityDislocationAustenite::calculateSlipResistance()
{
  Real taylor_hardening;
...
void
CrystalPlasticityDislocationAustenite::calculateEquivalentSlipIncrement(
...
void
CrystalPlasticityDislocationAustenite::calculateConstitutiveSlipDerivative(
...
bool
CrystalPlasticityDislocationAustenite::areConstitutiveStateVariablesConverged()
{
...
void
CrystalPlasticityDislocationAustenite::updateSubstepConstitutiveVariableValues()
{
...
void
CrystalPlasticityDislocationAustenite::cacheStateVariablesBeforeUpdate()
{
...
void
CrystalPlasticityDislocationAustenite::calculateStateVariableEvolutionRateComponent()
{
  Real rho_sum;
...
void
CrystalPlasticityDislocationAustenite::ArmstrongFrederickBackstressUpdate()
{
  for (const auto i : make_range(_number_slip_systems)) 
  {
...
bool
CrystalPlasticityDislocationAustenite::updateStateVariables()
{
