...
class ActDeactElementsUserObjectBase : public ElementUserObject
{
public:
  static InputParameters validParams();

  ActDeactElementsUserObjectBase(const InputParameters & parameters);
...
protected:
  ...
  /// activate subdomain ID = solid
  const subdomain_id_type _active_subdomain_id;
  /// deactivated subdomain ID = gas or liquid
  const subdomain_id_type _deactive_subdomain_id;  
