...
/**
 * CrystalPlasticityUndamagedStress is very similar to ComputeCrystalPlasticityStressDamage
 ...
 * The physical meaning is that the damaged material represents regions in which cavities are present,
 * therefore the macroscopic stress is the damaged one but the microscopic stress that determines
 * plasticity on the material next to the cavities is the undamaged one.
 *
 ...
 */
class CrystalPlasticityUndamagedStress : public ComputeMultipleCrystalPlasticityStress
{
public:
  static InputParameters validParams();

  CrystalPlasticityUndamagedStress(const InputParameters & parameters);
