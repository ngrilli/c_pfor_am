 ...
 *
 */
class FiniteStrainCrystalPlasticityBackstress : public FiniteStrainCrystalPlasticity
{
public:
  static InputParameters validParams();

  FiniteStrainCrystalPlasticityBackstress(const InputParameters & parameters);
...
protected:
  ...
  */
  ...
  // Temporary variables for the backstress
  // dimension of the vectors must be assigned in the constructor
  std::vector<Real> _tau_b_tmp;
  std::vector<Real> _tau_b_tmp_old;
