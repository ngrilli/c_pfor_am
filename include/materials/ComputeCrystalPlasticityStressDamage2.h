 ...
 */
class ComputeCrystalPlasticityStressDamage2 : public ComputeMultipleCrystalPlasticityStress
{
public:
  static InputParameters validParams();

  ComputeCrystalPlasticityStressDamage2(const InputParameters & parameters);
