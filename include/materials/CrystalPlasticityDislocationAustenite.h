...
class CrystalPlasticityDislocationAustenite;
...
class CrystalPlasticityDislocationAustenite : public CrystalPlasticityDislocationUpdateBase
{
public:
  static InputParameters validParams();

  CrystalPlasticityDislocationAustenite(const InputParameters & parameters);
...
protected:
  ...
  const Real _static_recovery_A;
  const Real _static_recovery_Q;
  const Real _gas_constant_R;  
