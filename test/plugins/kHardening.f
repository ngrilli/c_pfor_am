...
C      INCLUDE 'ABA_PARAM.INC'
    ...
    ! alpha-Uranium model
      ...
      rhofor(1) = rhofor(1) + 
     + 43.2*max(sqrt(rhofor(1)) - 
     + (0.17100+2.6093e-03*Temperature)*rhofor(1),0.0) * 
     + tgammaDot(1)*dtime
	 
      rhofor(2) = rhofor(2) + 
     + 6320.0*max(sqrt(rhofor(2)) - 
     + (0.25650+5.8708e-04*Temperature)*rhofor(2),0.0) * 
     + tgammaDot(2)*dtime
	 
      rhofor(3) = rhofor(3) + 
     + 0.24*max(sqrt(rhofor(3)) -
     + (0.11718+1.9289e-04*Temperature)*rhofor(3),0.0) * 
     + tgammaDot(3)*dtime
	 
      rhofor(4) = rhofor(4) + 
     + 0.24*max(sqrt(rhofor(4)) - 
     + (0.11718+1.9289e-04*Temperature)*rhofor(4),0.0) * 
     + tgammaDot(4)*dtime
	 
      rhofor(5) = rhofor(5) + 
     + 800.0*max(sqrt(rhofor(5)) -
     + (0.12+1.5e-05*Temperature)*rhofor(5),0.0) *
     + tgammaDot(5)*dtime

      rhofor(6) = rhofor(6) + 
     + 800.0*max(sqrt(rhofor(6)) -
     + (0.12+1.5e-05*Temperature)*rhofor(6),0.0) *
     + tgammaDot(6)*dtime
	 
      rhofor(7) = rhofor(7) + 
     + 800.0*max(sqrt(rhofor(7)) - 
     + (0.12+1.5e-05*Temperature)*rhofor(7),0.0) *
     + tgammaDot(7)*dtime
	 
      rhofor(8) = rhofor(8) + 
     + 800.0*max(sqrt(rhofor(8)) -
     + (0.12+1.5e-05*Temperature)*rhofor(8),0.0) * 
     + tgammaDot(8)*dtime

        ! substructure dislocations evolution
      rhosub = rhosub + 
     + 0.216*(17.545+0.26771*Temperature)*
