...
C      INCLUDE 'ABA_PARAM.INC'
      ...
      tauc(1) = tauc(1) + 
     + 19.066 * sqrt(rhofor(1)) + 1.8218 * sqrt(rhosub) * 
     + log(1.0 / (burgerv(1) * sqrt(rhosub)))
	 
      tauc(2) = tauc(2) + 
     + 18.832 * sqrt(rhofor(2)) + 1.7995 * sqrt(rhosub) * 
     + log(1.0 / (burgerv(2) * sqrt(rhosub)))
	 
      tauc(3) = tauc(3) + 
     + 54.052 * sqrt(rhofor(3)) + 5.1650 * sqrt(rhosub) * 
     + log(1.0 / (burgerv(3) * sqrt(rhosub)))
	 
      tauc(4) = tauc(4) + 
     + 54.052 * sqrt(rhofor(4)) + 5.1650 * sqrt(rhosub) * 
     + log(1.0 / (burgerv(4) * sqrt(rhosub)))
	 
      tauc(5) = tauc(5) + 
     + 123.357 * sqrt(rhofor(5)) + 11.7875 * sqrt(rhosub) * 
     + log(1.0 / (burgerv(5) * sqrt(rhosub)))
	 
      tauc(6) = tauc(6) + 
     + 123.357 * sqrt(rhofor(6)) + 11.7875 * sqrt(rhosub) * 
     + log(1.0 / (burgerv(6) * sqrt(rhosub)))
	 
      tauc(7) = tauc(7) + 
     + 123.357 * sqrt(rhofor(7)) + 11.7875 * sqrt(rhosub) * 
     + log(1.0 / (burgerv(7) * sqrt(rhosub)))
	 
      tauc(8) = tauc(8) + 
     + 123.357 * sqrt(rhofor(8)) + 11.7875 * sqrt(rhosub) * 
     + log(1.0 / (burgerv(8) * sqrt(rhosub)))
