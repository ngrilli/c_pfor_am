...
[Variables]
  ...
  [./rho_edge] # Edge dislocation density
    order = FIRST
    family = LAGRANGE
	[./InitialCondition]
      type = FunctionIC
      function = init_rho_edge
    [../]
  [../]
  
  [./rho_screw] # Screw dislocation density
    order = FIRST
    family = LAGRANGE
	[./InitialCondition]
      type = FunctionIC
      function = init_rho_screw
    [../]
  [../]
[]
...
# Hull, Bacon, Dislocations, figure 3.11a
	...
	rho_edge_pos_1 = rho_edge
	rho_screw_pos_1 = rho_screw
  [../]
  [./elasticity_tensor]
