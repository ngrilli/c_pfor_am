...
[Kernels]
  ...
  [../]  
  [./rho_edge_pos_annih]
    type = DisloAnnihilation
	variable = rho_edge_pos
	rho_annih = rho_edge_neg
	slip_sys_index = 0
	dc = 0.0012 # microns, Catalao 2005
  [../]
  [./drho_edge_neg_dt]
    type = MassLumpedTimeDerivative
  ...
  [./rho_screw_pos_annih]
    type = DisloAnnihilation
	variable = rho_screw_pos
	rho_annih = rho_screw_neg
	slip_sys_index = 0
	dc = 0.050 # microns, Grilli 2016, PhD thesis	
  [../]
  [./drho_screw_neg_dt]
    type = MassLumpedTimeDerivative
