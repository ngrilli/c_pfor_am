...
# initial GND densities are read from file
# and a corresponding initial Fp based on the
# inverse rotation matrix is assigned point by point
# Since the stress equation is rotation-independent
# this initial Fp does not cause an initial stress
...
[UserObjects]
  ...
  [./init_GND_read]
	...
	prop_file_name = 'initial_GND.txt'
	nprop = 24
    read_type = element
  [../]
...
[Materials]
  ...
  [./stress]
	...
	read_initial_Fp = init_Fp_read
  [../]
  [./trial_xtalpl]
    type = CrystalPlasticityDislocationUpdate
    number_slip_systems = 12
    slip_sys_file_name = input_slip_sys.txt
	read_initial_gnd_density = init_GND_read
	ao = 0.001
	xm = 0.1
