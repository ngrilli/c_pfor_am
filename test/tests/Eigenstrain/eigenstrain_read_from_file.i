...
# in this case non-zero components are yy and yz
# that induces a linearly increasing eigenstrain yy along y
# and a uniform shear strain yz
...
[UserObjects]
  [./prop_read]
    ...
    ngrain = 1
  [../]
  [./initial_def_prop_read]
    type = ElementPropertyReadFile
    prop_file_name = 'initial_residual_def_file.txt'
    nprop = 9
    read_type = element
  [../]
[]
...
[Materials]
  ...
  [residual_eigenstrain_1]
    ...
    read_initial_residual_def = initial_def_prop_read
  []
  [./trial_xtalpl]
