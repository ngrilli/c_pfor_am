...
# crack nucleation without pre-existing crack
# It corresponds to the model used for simulation in Figure 16 of
...
[Kernels]
  # kernels for model with nucleation 
  # equations (29) and (30) in the paper
  [./ACBulk]
    type = AllenCahn
    variable = c
    f_name = F
  ...
  [./BodyForce]
    type = BodyForce
    variable = c
    value = -5.0 # this has opposite sign compared with Ce value in the paper because of minus sign in the BodyForce kernel
  [../]
...
#   see table 4 in the paper
  ...
  # use a formulation proportional to c, not c^2, otherwise initial jump in c
  # this leads to the term -Gc / l_0 in equations (29) and (30) in the paper) 
  [./local_fracture_energy]
    type = DerivativeParsedMaterial
    property_name = local_fracture_energy
    coupled_variables = 'c'
    material_property_names = 'gc_prop l'
    expression = 'c * gc_prop / l'
    derivative_order = 2
  [../]
